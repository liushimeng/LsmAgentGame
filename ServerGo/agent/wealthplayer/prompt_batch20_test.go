// Package wealthplayer — prompt_batch20_test.go: 批次20 三块上下文小节渲染
...
func batch20Ctx() *wealthtypes.GameContext {
	return &wealthtypes.GameContext{
		Month: 5, Age: 25,
		Cycle:  wealthtypes.CycleBrief{Phase: "recovery", LPR: 0.035, CPI: 0.02, MonthsLeft: 10},
		Market: wealthtypes.MarketBrief{StockIndex: 3.5, GoldPrice: 750, BondRate: 0.032},
		Me:     wealthtypes.SelfBrief{Cash: 100000, Energy: 5, Network: 3, Cognition: 4, ActionBudget: 3},
	}
}
