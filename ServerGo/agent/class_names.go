...
//   3. 命名规则:
//      - 游戏无关通用 Agent     → "LsmWebGame-<职能>" (例:未来 "LsmWebGame-Sandbox")
//      - 狼人杀玩家 Bot          → "LsmWebGame-Werewolf-Player"
//      - 狼人杀法官 Bot          → "LsmWebGame-Werewolf-Judge"
//      - 其他游戏玩家 Bot        → "LsmWebGame-<Game>-Player"
...
const (
	...
	AgentClassWerewolfPlayer AgentClassName = "LsmWebGame-Werewolf-Player"
	...
	AgentClassWerewolfJudge AgentClassName = "LsmWebGame-Werewolf-Judge"
	...
	AgentClassWerewolfMemoryIter AgentClassName = "LsmWebGame-Werewolf-MemoryIter"
	...
	AgentClassWerewolfProfileIter AgentClassName = "LsmWebGame-Werewolf-ProfileIter"
	...
	AgentClassWerewolfRecall AgentClassName = "LsmWebGame-Werewolf-Recall"
	...
	AgentClassWerewolfCommentator AgentClassName = "LsmWebGame-Werewolf-Commentator"
)
