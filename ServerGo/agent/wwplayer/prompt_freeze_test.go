...
func TestPromptFreeze_BytesStableAcrossCalls(t *testing.T) {
	a := BuildSystemPromptBytes("portrait", PersonalityVector{}, "logical", "", false)
	b := BuildSystemPromptBytes("portrait", PersonalityVector{}, "logical", "", false)
...
func TestPromptFreeze_StableHashMatches(t *testing.T) {
	h1 := HashSystemPromptBytes("portrait", PersonalityVector{}, "logical", "", false)
	h2 := HashSystemPromptBytes("portrait", PersonalityVector{}, "logical", "", false)
	if h1 != h2 {
...
func TestPromptFreeze_DifferentParamsDifferentBytes(t *testing.T) {
	a := BuildSystemPromptBytes("portrait", PersonalityVector{}, "logical", "", false)
	b := BuildSystemPromptBytes("portrait_different", PersonalityVector{}, "logical", "", false)
	if string(a) == string(b) {
...
func TestPromptFreeze_DifficultyDirectiveChangesBytes(t *testing.T) {
	a := BuildSystemPromptBytes("", PersonalityVector{}, "", "", false)
	b := BuildSystemPromptBytes("", PersonalityVector{}, "", "difficulty: hard", false)
	if string(a) == string(b) {
...
func TestPromptFreeze_NonEmpty(t *testing.T) {
	b := BuildSystemPromptBytes("", PersonalityVector{}, "", "", false)
	if len(b) == 0 {
