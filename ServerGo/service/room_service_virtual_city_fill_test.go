...
func TestCreatorShouldBeSpectator_VirtualCityDeepSeats(t *testing.T) {
	cases := []struct {
		...
		{"wealth 12 deep seats downgrades creator", "virtual_city", 0, 12, true},
		{"wealth lower counts still guarded by free seats", "virtual_city", 0, 3, true},
		{"wealth free seats keep creator player", "virtual_city", 3, 9, false},
