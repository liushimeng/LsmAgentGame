 ...
 *
 * 规约（02-架构设计 §2）：
 *   - URL 拼接：`./<category>/<name>.glb`，category ∈ {civic,vehicles,nature,characters,road}
...
export type ModelCategory = 'civic' | 'vehicles' | 'nature' | 'characters' | 'road';

/**
 * 模型 URL（缺失 = ''，调用方退回原程序化几何）。
 * @param category 类别（civic/vehicles/nature/characters/road）
